...
from guard_core.sync.prompt_injection.format_strategies import FormatStrategyFactory
...
<<<<<<< Updated upstream
    ...
    def _should_skip(self, request: SyncGuardRequest) -> bool:
...
<<<<<<< Updated upstream
    ...
    def _extract_text(self, request: SyncGuardRequest) -> str:
    ...
    def _store_helpers(self, request: SyncGuardRequest, text: str) -> None:
    ...
    def _log_detection(self, request: SyncGuardRequest, result: InjectionScore) -> None:
