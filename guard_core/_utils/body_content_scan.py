...
async def _scan_json_dict_entry(
    key: Any,
    item: Any,
...
async def _scan_json_dict(
    ...
    for key, item in value.items():
        hit = await _scan_json_dict_entry(
            key,
            item,
            excluded_body_fields,
            enabled_categories,
