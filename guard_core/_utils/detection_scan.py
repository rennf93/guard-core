...
async def _user_agent_matches_blocked_pattern(
    user_agent: str, patterns: list[str]
) -> bool:
...
async def _check_embedded_json_if_applicable(
    value: str,
    context: str,
    client_ip: str,
    correlation_id: str,
...
async def _check_value_enhanced(
    ...
    json_hit = await _check_embedded_json_if_applicable(
        value,
        context,
        client_ip,
        correlation_id,
