...
async def test_ldap_wildcard_breakout_gap_tolerant_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_wildcard_breakout_case_variant_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_wildcard_breakout_extensible_match_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_paren_breakout_no_wildcard_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_paren_breakout_inert_bare_attribute_not_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
...
async def test_ldap_paren_breakout_attacker_controlled_wildcard_clause_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
...
async def test_ldap_paren_breakout_field_boundary_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_paren_breakout_local_balance_not_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="198.51.100.4", context="request_body"
    )
    assert not any(threat.get("category") == "ldap" for threat in result["threats"])
...
async def test_ldap_paren_breakout_truncated_prose_not_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="198.51.100.4", context="request_body"
    )
    assert not any(threat.get("category") == "ldap" for threat in result["threats"])
...
async def test_ldap_wildcard_breakout_complete_clause_not_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="198.51.100.4", context="request_body"
...
async def test_ldap_wildcard_equals_hyphenated_attr_not_a_filter_shape_not_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
...
async def test_ldap_wildcard_equals_hyphenated_benign_prose_not_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
...
async def test_ldap_wildcard_equals_crontab_shapes_not_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert not any(threat.get("category") == "ldap" for threat in result["threats"])
...
async def test_ldap_paren_breakout_scan_window_truncated_clause_not_flagged(
    payload: str,
) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="198.51.100.4", context="request_body"
...
async def test_ldap_paren_breakout_comparator_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
...
async def test_ldap_rfc4515_hex_escape_flagged(payload: str) -> None:
    result = await sus_patterns_handler.detect(
        content=payload, ip_address="203.0.113.9", context="request_body"
    )
    assert result["is_threat"] is True
