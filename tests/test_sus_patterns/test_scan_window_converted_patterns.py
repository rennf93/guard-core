...
async def test_embedded_terminator_payload_still_detected(
...
async def test_benign_content_not_flagged(case_id: str, payload: str) -> None:
    result = await _MANAGER.detect(payload, "203.0.113.9", "request_body")
