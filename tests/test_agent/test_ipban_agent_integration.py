...
@pytest.mark.asyncio
async def test_initialize_agent(cleanup_ipban_singleton: None) -> None:
    IPBanManager._instance = None
...
@pytest.mark.asyncio
async def test_send_ban_event_success(cleanup_ipban_singleton: None) -> None:
    IPBanManager._instance = None
...
@pytest.mark.asyncio
async def test_unban_ip_with_agent(cleanup_ipban_singleton: None) -> None:
    IPBanManager._instance = None
...
@pytest.mark.asyncio
async def test_send_unban_event_success(cleanup_ipban_singleton: None) -> None:
    IPBanManager._instance = None
