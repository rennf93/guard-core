...
def cleanup_cloud_singleton() -> Generator[Any, Any, Any]:
    ...
    with (
        ...
        patch(
            "guard_core.handlers.cloud_handler.SecurityEvent", create=True
        ) as mock_event,
    ):
...
@pytest.mark.asyncio
async def test_send_cloud_detection_event_no_agent() -> None:
    manager = CloudManager()
...
@pytest.mark.asyncio
async def test_send_cloud_detection_event_with_agent() -> None:
    manager = CloudManager()
    mock_agent = AsyncMock()
...
@pytest.mark.asyncio
async def test_send_cloud_event_no_agent_handler() -> None:
    manager = CloudManager()
    manager.agent_handler = None
...
@pytest.mark.asyncio
async def test_send_cloud_event_success() -> None:
    manager = CloudManager()
    mock_agent = AsyncMock()
    manager.agent_handler = mock_agent
