...
from guard_core.sync.prompt_injection.pattern_tester import PatternTester
...
class TestPatternTesterAdditionalCases:
    ...
    def test_add_test_case_with_category(self, populated_tester: PatternTester) -> None:
        from guard_core.sync.prompt_injection import PatternCategory
    ...
    def test_load_test_suite_missing_file(self, tmp_path: Path) -> None:
        from guard_core.sync.prompt_injection import PatternManager, PatternTester
    ...
    def test_generate_report_with_needs_improvement(
        ...
        from guard_core.sync.prompt_injection import InjectionPattern, PatternCategory
