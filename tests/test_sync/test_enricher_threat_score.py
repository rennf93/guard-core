...
def test_enrich_event_populates_threat_score() -> None:
    enricher = _enricher()
...
def test_enrich_event_skips_threat_score_when_event_type_missing() -> None:
    enricher = _enricher()
...
def test_enrich_event_unknown_type_gets_default_score() -> None:
    enricher = _enricher()
