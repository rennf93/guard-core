...
def test_require_ip_whitelist() -> None:
    d = _decorator()
...
def test_require_ip_blacklist() -> None:
    d = _decorator()
...
def test_block_clouds_default() -> None:
    d = _decorator()
...
def test_require_auth_bearer() -> None:
    d = _decorator()
...
def test_require_auth_conflicts_with_authorization_header() -> None:
    d = _decorator()
...
def test_api_key_auth_conflicts_with_authorization_header() -> None:
    d = _decorator()
    d.require_authorization_header(scheme="bearer")(_sample_func)
    with pytest.raises(ValueError, match="require_authorization_header"):
...
def test_require_authorization_header_conflicts_with_auth_required() -> None:
    d = _decorator()
    d.require_auth(type="bearer")(_sample_func)
    with pytest.raises(ValueError, match="require_authorization_header"):
        d.require_authorization_header(scheme="bearer")(_sample_func)
...
def test_require_authorization_header_conflicts_with_api_key() -> None:
    d = _decorator()
    d.api_key_auth(header_name="X-Key")(_sample_func)
    with pytest.raises(ValueError, match="require_authorization_header"):
        d.require_authorization_header(scheme="bearer")(_sample_func)
...
def test_suspicious_detection() -> None:
    d = _decorator()
...
def test_honeypot_detection_json_no_trigger() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_honeypot_detection_form_trigger() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_honeypot_detection_get_request() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_honeypot_detection_unknown_content_type() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_honeypot_detection_form_no_trigger() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_honeypot_detection_invalid_json() -> None:
    d = _decorator()
    decorated = d.honeypot_detection(trap_fields=["honeypot"])(_sample_func)
    rc = d.get_route_config(decorated._guard_route_id)
    assert rc is not None
...
def test_block_user_agents() -> None:
    d = _decorator()
...
def test_max_request_size() -> None:
    d = _decorator()
...
def test_require_referrer() -> None:
    d = _decorator()
...
def test_suspicious_frequency() -> None:
    d = _decorator()
...
def test_simple_response_properties() -> None:
