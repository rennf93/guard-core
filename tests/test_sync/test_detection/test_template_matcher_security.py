...
from guard_core.sync.handlers._suspatterns_state import _LEGACY_DETECTION_STATE
...
def test_template_registry_precedes_regex_fallback_without_a_scan_cap(
    label: str,
    source: str,
    scanner: _Scanner,
    opening: str,
    ...
    def unexpected_legacy_fallback(
