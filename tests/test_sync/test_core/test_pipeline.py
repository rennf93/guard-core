...
def test_pipeline_skips_block_log_when_check_is_muted(
...
def test_pipeline_skips_error_log_when_check_is_muted(
    mock_middleware: Mock, caplog: pytest.LogCaptureFixture
) -> None:
    import logging
...
def test_pipeline_skips_fail_secure_log_when_check_is_muted(
    mock_middleware: Mock, caplog: pytest.LogCaptureFixture
) -> None:
    import logging
