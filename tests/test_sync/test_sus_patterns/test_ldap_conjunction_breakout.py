...
def test_rfc4515_hex_escape_fires_through_wire_entry(payload: str) -> None:
    assert _body_is_threat(payload) is True
    categories = _body_categories(payload)
    assert "ldap" in categories
...
def test_wildcard_breakout_fires_regardless_of_leading_junk_length(
    payload: str,
) -> None:
    assert _body_is_threat(payload) is True
    categories = _body_categories(payload)
...
def test_paren_breakout_fires_regardless_of_trailing_junk_length(
    payload: str,
) -> None:
    assert _body_is_threat(payload) is True
    categories = _body_categories(payload)
