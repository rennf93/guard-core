...
def test_opcode_prefix_at_window_boundary_lengths_detected_via_real_entry_point(
...
def test_opcode_prefix_beyond_work_budget_still_flags(prefix_len: int) -> None:
